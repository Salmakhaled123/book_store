...
class BookViewBody extends StatelessWidget {
            ...
            itemBuilder: (context,index)
             {
               ...
               return InkWell(onTap: (){
                 Navigator.push(context, MaterialPageRoute(builder: (context)=>BookDetailsView(model: cubit.books[index])));
               },
                 child: Padding(
  ...
  builder: (context, state) {
    ...
    return IconButton(onPressed: (){
                                  cubit2.addToWishList(cubit.books[index].id,context);
                                 },
                                     icon:cubit2.favorites.contains(cubit.books[index].id)?
