    ...
    return BlocBuilder<HomeCubit, HomeState>(
      builder: (context, state) {
        ...
        return ListView.builder(physics: const BouncingScrollPhysics(),
            ...
            itemCount: cubit.booksModel?.data.products.length,
                  ...
                  children: [
                    SizedBox(height: 125.h,
                      child: ClipRRect(
                        ...
                        child: CachedNetworkImage(
                          imageUrl: cubit.booksModel?.data.products[index].image ??''  ,
                          fit: BoxFit.fill,
                    ...
                    Column(crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        SizedBox(width: 100,
                          child: Text(cubit.booksModel?.data.products[index].name??'',
                            style: Styles.textStyle20,overflow: TextOverflow.ellipsis,maxLines: 1,),
                        ),

                        Text(cubit.booksModel?.data.products[index].category ?? '',style: Styles.textStyle16.copyWith(color: Colors.grey),),
                        SizedBox(height: 5.h,),
                        Text('${cubit.booksModel?.data.products[index].priceAfterDiscount ?? ''} L.E',style: Styles.textStyle16.copyWith(
