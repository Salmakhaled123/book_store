...
class BestSellerBooksViewBody extends StatelessWidget {
  const BestSellerBooksViewBody({Key? key}) : super(key: key);
  @override
                  ...
                  children: [
                    SizedBox(height: 125.h,
                      child: ClipRRect(
                        ...
                        child: CachedNetworkImage(
                          imageUrl: cubit.bestSellerModel?.data.products[index].image ??''  ,
                          fit: BoxFit.fill,
                    ...
                    Column(crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        SizedBox(width: 100,
                          child: Text(cubit.bestSellerModel?.data.products[index].name??'',
                            style: Styles.textStyle20,overflow: TextOverflow.ellipsis,maxLines: 1,),
                        ),

                        Text(cubit.bestSellerModel?.data.products[index].category ?? '',style: Styles.textStyle16.copyWith(color: Colors.grey),),
                        SizedBox(height: 5.h,),
                        Text('${cubit.bestSellerModel?.data.products[index].priceAfterDiscount ?? ''} L.E',style: Styles.textStyle16.copyWith(
