              ...
              child: Column(  crossAxisAlignment: CrossAxisAlignment.center,
               ...
               Image.asset(AppImages.register,width: 200.w,height: 200.h,),
                ...
                CustomTextFormField(validate: (value)
                {
                  ...
                  CustomTextFormField(controller: cubit.emailController, hintText: 'Email', prefix: Icons.email, obscureText: false, type: TextInputType.emailAddress,
                      validate: (value){
                    if(value!.isEmpty)
                      {
                  ...
                  CustomTextFormField(suffixIcon: IconButton(onPressed: (){
                    cubit.changeVisibilityConfirmPassword();
                      ...
                      icon: cubit.suffixConfirmPass ? const Icon(Icons.visibility_off):
                      const Icon(Icons.visibility)),
                      validate: (value){
                        if(value!.isEmpty)
                        {
                      ...
                      controller: cubit.confirmController, hintText: 'confirm password', prefix: Icons.password, obscureText: cubit.suffixConfirmPass,
                      type: TextInputType.visiblePassword),
                  SizedBox(
                    height: 20.h,
                  ),
                  ...
                  SizedBox(
                    ...
                    child: Container(decoration:   BoxDecoration(borderRadius: BorderRadius.circular(16.0),
                      ...
                      child: ElevatedButton(
                          ...
                          child: state is LoginRegisterLoading ? SizedBox(width: 24.w,height: 24.h,child: const Center(child: CircularProgressIndicator()),)
                         : const Text('REGISTER')),
                    ),
                  ),
